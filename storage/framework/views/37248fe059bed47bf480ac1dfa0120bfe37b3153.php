...
<form action="javascript:void(0)" id="studentsEditForm" name="studentsEditForm"  enctype="multipart/form-data">
    <input type="hidden" name="id" class="form-control" id="id" value="<?php echo e($students->studentsId); ?>">
    <div class="card-body">
        <div class="form-group">
            <label for="color"> Student Name <span style="color:#ff0000">*</span></label>
                <input type="text" name="studentName" class="form-control" id="studentName" placeholder="Enter  Stuents Name" value="<?php echo e($students->studentName); ?>">
            <div class="error" id="studentNameErr"></div>
        </div>

        <div class="form-group">
            <label for="color"> Course Name <span style="color:#ff0000">*</span></label>
                <input type="text" name="courseName" class="form-control" id="courseName" placeholder="Enter Course Name " value="<?php echo e($students->courseName); ?>">
            <div class="error" id="courseNameErr"></div>
        </div>

        <div class="form-group">
            <label for="color"> Email <span style="color:#ff0000">*</span></label>
                <input type="text" name="email" class="form-control" id="email" placeholder="Enter Email Name " value="<?php echo e($students->email); ?>">
            <div class="error" id="emailErr"></div>
        </div>

        <div class="form-group">
            <label for="color"> Mobile Number <span style="color:#ff0000">*</span></label>
                <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Enter Mobile Name " value="<?php echo e($students->mobileNumber); ?>">
        ...
        <div class="form-group">
            ...
            <div class="form-group" id="students_image_div" >
                ...
                <div class="input-group">
                    <img id="students_image" name="students_image" src="<?php echo e(asset('images/').'/'.$students->studentImage); ?>" alt="your image" style="width: 12% !important;" />
                </div>
                <?php }else{ ?>
                <div class="input-group">
            ...
            <input type='file' id="students_input_image" onchange="readURL(this);"  name="students_input_image" value="<?php echo e($students->studentImage); ?>" data-value="<?php echo e($students->studentImage); ?>" class="form-control" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Bliss-technologies\resources\views/students/students-edit.blade.php ENDPATH**/ ?>