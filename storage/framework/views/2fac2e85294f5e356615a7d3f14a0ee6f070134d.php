    ...
    <script type="text/javascript">  
        ...
        $("#bookReturnForm").submit(function(e) {
            ...
            if( 1 == flag ){
                ...
                $.ajax({
                    url:"<?php echo e(route('book_issue.store')); ?>",
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Bliss-technologies\resources\views/library/library-return.blade.php ENDPATH**/ ?>